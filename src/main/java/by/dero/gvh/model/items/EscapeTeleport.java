...
public class EscapeTeleport extends Item implements DoubleSpaceInterface {
    ...
    public void onDoubleSpace() {
        ...
        cooldown.reload();
        owner.getWorld().playSound(owner.getLocation(), Sound.ENTITY_ELDER_GUARDIAN_AMBIENT, 1.07f, 1);
        loc.getWorld().playSound(loc, Sound.ENTITY_ELDER_GUARDIAN_AMBIENT, 1.07f, 1);
