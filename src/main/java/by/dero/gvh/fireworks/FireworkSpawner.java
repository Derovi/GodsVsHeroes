...
public class FireworkSpawner {
	...
	public static void spawn(Location location, FireworkEffect effect, Player...players){
		...
		try{
			...
			jDataWatcherItem<net.minecraft.server.v1_12_R1.ItemStack> i6=new jDataWatcherItem<net.minecraft.server.v1_12_R1.ItemStack>(
					jDataWatcherObject.entityfireworks_itemstack, CraftItemStack.asNMSCopy(item));
